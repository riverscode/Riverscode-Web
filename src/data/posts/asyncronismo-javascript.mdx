---
title: "¿Que diablos respondo sobre el Asincronismo con JavaScript?"
...
function UseHability(fruitName) {
  console.log(`Ahora puedo usar el poder de la fruta  ${fruitName}`);
}
  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      if (fruitName === "mera mera no mi") {
        resolve(`Ahora puedo usar el poder de la fruta  ${fruitName}`);
      } else {
