      ...
      <div className="flex sm:flex-row flex-col gap-5 w-full items-center justify-between mx-auto max-w-screen-md">
        <div>
          <p className="text-lg font-medium flex items-center">
            ...
            <span className="leading-tight">Comparte este artículo con tus amigos</span>
          </p>
        </div>
        <div className="pt-0 flex sm:w-auto w-full items-center divide-x divide-gray-900 justify-center border-t md:border-transparent border-gray-900">
          <a href={`https://twitter.com/intent/tweet/?text=${title};url=https://riverscode.vercel.app/blog/${slug}`} className="w-full flex items-center justify-center h-full px-7 py-7 hover:bg-gray-700/30 transition" target="_blank" rel="noopener noreferrer">
